...
public final class WorldMapSampler {
    ...
    public static int sample(Minecraft minecraft, long seed, int worldX, int worldZ) {
        ...
        return placeholder(seed, Identifier.parse("overworld"), worldX, worldZ);
    }
    ...
    public static int placeholder(long seed, Identifier dimension, int worldX, int worldZ) {
        return 0xFF9C9C9C;
    }
    ...
    private static int sampleFromLevel(Level level, long seed, int worldX, int worldZ) {
        ...
        if (!level.hasChunkAt(column)) {
            return placeholder(seed, level.dimension().identifier(), worldX, worldZ);
        }
    ...
    private static int sampleNetherColumn(Level level, long seed, int worldX, int worldZ) {
        ...
        int top = Math.max(level.getMinY() + 2, Math.min(level.getMaxY() - 8, playerY + 8));
        int bottom = Math.max(level.getMinY() + 2, playerY - 48);
    ...
    private static int fallbackColor(long seed, Identifier dimension, int worldX, int worldZ) {
