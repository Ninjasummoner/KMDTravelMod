...
public final class TravelMapHandRenderer {
    ...
    public static void renderHand(RenderHandEvent event) {
        ...
        renderHands(poseStack, collector, packedLight, minecraft.player, easedProgress);
    ...
    private static void renderMapHand(
        ...
        if (right) {
            renderer.renderRightHand(poseStack, collector, packedLight, player.getSkin().body().texturePath(), false, player);
        } else {
            renderer.renderLeftHand(poseStack, collector, packedLight, player.getSkin().body().texturePath(), false, player);
        }
        poseStack.popPose();
    }
