...
public class TravelSavedData extends SavedData {
    ...
    public static TravelSavedData get(ServerLevel level) {
        return level.getServer().overworld().getDataStorage().computeIfAbsent(TravelSavedData::load, TravelSavedData::new, NAME);
    }

    public static TravelSavedData load(CompoundTag tag) {
