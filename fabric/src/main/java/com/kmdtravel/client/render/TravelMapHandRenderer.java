...
public final class TravelMapHandRenderer {
    ...
    public static boolean renderHeld(PoseStack poseStack, MultiBufferSource buffers, int packedLight,
            AbstractClientPlayer player, float partialTick) {
        if (!player.getMainHandItem().is(KMDItems.TRAVEL_MAP.get())) return false;
        ...
        renderHands(poseStack, buffers, packedLight, player, easedProgress);
