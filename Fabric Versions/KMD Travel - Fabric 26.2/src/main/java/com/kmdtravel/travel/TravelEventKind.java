...
public enum TravelEventKind {
    BANDIT_AMBUSH("bandit_ambush", List.of(EntityTypes.PILLAGER, EntityTypes.ZOMBIE), false),
    NIGHT_ATTACK("night_attack", List.of(EntityTypes.ZOMBIE, EntityTypes.SKELETON, EntityTypes.SPIDER), false),
    FOREST_AMBUSH("forest_ambush", List.of(EntityTypes.SPIDER, EntityTypes.SKELETON), false),
    SWAMP_TROUBLE("swamp_trouble", List.of(EntityTypes.SLIME, EntityTypes.ZOMBIE), false),
    DESERT_RAIDERS("desert_raiders", List.of(EntityTypes.HUSK, EntityTypes.SKELETON), false),
    ROADBLOCK("roadblock", List.of(EntityTypes.PILLAGER, EntityTypes.VINDICATOR), false),
    ILLAGER_PATROL("illager_patrol", List.of(EntityTypes.PILLAGER, EntityTypes.VINDICATOR), false),
    CAVE_ROBBERS("cave_robbers", List.of(EntityTypes.ZOMBIE, EntityTypes.SKELETON), false),
    WOLF_PACK("wolf_pack", List.of(EntityTypes.WOLF), false),
    ...
    SEA_PIRATES("sea_pirates", List.of(EntityTypes.DROWNED, EntityTypes.PILLAGER), true),
    DROWNED_RAID("drowned_raid", List.of(EntityTypes.DROWNED), true),
