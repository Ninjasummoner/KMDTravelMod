...
public final class HeldTravelMapRenderer {
    ...
    public static void render(
        ...
        Matrix4f mapPose = new Matrix4f(poseStack.last().pose());
        collector.submitCustomGeometry(poseStack, RenderType.entityCutoutNoCull(textureLocation),
                (pose, consumer) -> drawQuad(mapPose, consumer, packedLight, left, top, right, bottom, z, u0, 0.0F, u1, 1.0F));

        if (reveal > 0.08F) {
            renderPlayerHead(poseStack, collector, packedLight, player, z - 0.012F);
        }
    }
    ...
    private static void renderPlayerHead(
        ...
        Matrix4f headPose = new Matrix4f(poseStack.last().pose());
        collector.submitCustomGeometry(poseStack, RenderType.entityCutoutNoCull(skin), (pose, skinConsumer) -> {
        drawQuad(headPose, skinConsumer, packedLight,
    ...
    private static void drawQuad(
        ...
        drawQuad(poseStack.last(), consumer, packedLight, left, top, right, bottom, z, u0, v0, u1, v1);
    }
    ...
    private static void drawQuad(
        ...
        drawQuad(pose.pose(), consumer, packedLight, left, top, right, bottom, z, u0, v0, u1, v1);
    }
