...
public final class KMDItems {
    ...
    public static final Holder<CreativeModeTab> KMD_TRAVEL_TAB = holder(Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB,
            Identifier.fromNamespaceAndPath(KMDTravel.MOD_ID, "kmd_travel"),
    ...
    private static Item register(String name, java.util.function.Function<Identifier, Item> factory) {
